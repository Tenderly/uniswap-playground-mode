...
export const MULTICALL_ADDRESS: AddressMap = {
  ...
  [SupportedChainId.T_ARBITRUM_ONE]: '0xadF885960B47eA2CD9B55E6DAc6B42b7Cb2806dB',
  [SupportedChainId.T_CELO]: CELO_MULTICALL_ADDRESS,
  [SupportedChainId.T_CELO_ALFAJORES]: CELO_MULTICALL_ADDRESS,
  [SupportedChainId.T_BNB]: BNB_MULTICALL_ADDRESS,
  [SupportedChainId.T_OPTIMISM_GOERLI]: OPTIMISM_GOERLI_MULTICALL_ADDRESS,
  [SupportedChainId.T_ARBITRUM_GOERLI]: ARBITRUM_GOERLI_MULTICALL_ADDRESS,
  [SupportedChainId.T_SEPOLIA]: SEPOLIA_MULTICALL_ADDRESS,
}
